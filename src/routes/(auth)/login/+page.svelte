...
>
	<div class="relative flex h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
		<div
			...
			style="background-image: url(https://images.unsplash.com/photo-1590487988256-9ed24133863e?q=80&w=3428&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);"
		></div>
	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			...
			<p class="px-8 text-center text-sm text-muted-foreground">
				...
				<a target=”_blank” href="https://termify.io/terms-and-conditions/idL7IO4DHK" class="underline underline-offset-4 hover:text-primary">
					Terms of Service
				</a>
				and
				<a target=”_blank” href="https://termify.io/privacy-policy/OaexyPr85s" class="underline underline-offset-4 hover:text-primary">
					Privacy Policy
				</a>.
			</p>
		</div>
